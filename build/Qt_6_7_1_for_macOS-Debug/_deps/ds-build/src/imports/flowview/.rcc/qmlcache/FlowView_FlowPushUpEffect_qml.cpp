...
0x38,0x1a,0x0,0x0,0x34,0x30,0x34,0x63,
...
#endif
while (!aotContext->loadContextIdLookup(37, &r2_3)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(11);
#endif
...
#endif
while (!aotContext->getObjectLookup(38, r2_3, &r2_4)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(13);
#endif
aotContext->initGetObjectLookup(38, r2_3, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return QVariant();
}
{
...
aotContext->setInstructionPointer(15);
#endif
aotContext->initGetObjectLookup(39, r2_4, QMetaType::fromType<double>());
if (aotContext->engine->hasError())
    return QVariant();
}
