...
0xcc,0x8,0x0,0x0,0x34,0x30,0x34,0x63,
...
while (!aotContext->loadScopeObjectPropertyLookup(6, r2_2.data())) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(8);
#endif
aotContext->initLoadScopeObjectPropertyLookup(6, r2_2.metaType());
if (aotContext->engine->hasError())
    return double();
r2_2 = QVariant(aotContext->lookupResultMetaType(6));
}
...
aotContext->setInstructionPointer(10);
#endif
while (!aotContext->getValueLookup(7, r2_2.data(), &r2_3)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(10);
#endif
