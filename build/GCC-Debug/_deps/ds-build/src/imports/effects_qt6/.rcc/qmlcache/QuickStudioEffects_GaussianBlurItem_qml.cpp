...
0xac,0xd,0x0,0x0,0x34,0x30,0x34,0x63,
...
while (!aotContext->loadScopeObjectPropertyLookup(12, r2_2.data())) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(8);
#endif
aotContext->initLoadScopeObjectPropertyLookup(12, r2_2.metaType());
if (aotContext->engine->hasError())
    return double();
r2_2 = QVariant(aotContext->lookupResultMetaType(12));
}
...
#endif
while (!aotContext->getValueLookup(13, r2_2.data(), &r2_3)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(10);
#endif
...
while (!aotContext->loadScopeObjectPropertyLookup(16, r2_2.data())) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(8);
#endif
aotContext->initLoadScopeObjectPropertyLookup(16, r2_2.metaType());
if (aotContext->engine->hasError())
    return double();
r2_2 = QVariant(aotContext->lookupResultMetaType(16));
}
