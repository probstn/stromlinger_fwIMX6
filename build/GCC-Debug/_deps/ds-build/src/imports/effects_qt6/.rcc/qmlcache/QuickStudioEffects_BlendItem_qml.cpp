...
0x50,0xb,0x0,0x0,0x34,0x30,0x34,0x63,
...
aotContext->setInstructionPointer(17);
#endif
aotContext->initSetObjectLookup(12, r7_0, QMetaType::fromType<QVariant>());
if (aotContext->engine->hasError())
    return ;
}
}
...
#endif
while (!aotContext->getObjectLookup(15, r2_6, &r2_7)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(25);
#endif
aotContext->initGetObjectLookup(15, r2_6, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
{
...
#endif
while (!aotContext->setObjectLookup(16, r7_1, &r2_4)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(34);
#endif
aotContext->initSetObjectLookup(16, r7_1, QMetaType::fromType<QVariant>());
if (aotContext->engine->hasError())
    return ;
}
}
...
r2_8 = QStringLiteral("Blend is not supported with Qt 6");
{
}
// generate_StoreReg
r10_0 = std::move(r2_8);
